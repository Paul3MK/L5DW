...
<body class="bodygradient">
    <nav class="z-10 blur w-full hidden items-center justify-between flex-wrap lg:p-6 top-0 fixed">
        ...
        <div class="flex items-center flex-shrink-0 text-white mr-28">
            ...
            <img src="images/Logo-small.svg" alt="" class="inline-block lg:hidden" h=16 w=16>
        </div>
        <div class="z-20 lg:flex lg:items-center h-screen lg:h-auto lg:relative w-full">
            <span>
                <a href="#" class="block mt-4 lg:inline-block lg:mt-0 text-white hover:border-primary border-b border-2 border-transparent mr-4 font-archivo">
                    Home
                </a>
            </span>
            <span>
                <a href="#" class="block mt-4 lg:inline-block lg:mt-0 text-white hover:border-white border border-transparent mr-4 font-archivo">
                    About Us
                </a>
            </span>
            <span>
                <a href="contact.html" class="block mt-4 lg:inline-block lg:mt-0 text-indigo-200 hover:text-white mr-4 font-archivo">
                    Contact
                </a>
            </span>
            <span>
    ...
    <div id="pageWrapper" class="z-3 absolute top-0 grid grid-cols-4 mx-8">
        <img src="images/Logo-small.svg" alt="" class="inline-block lg:hidden col-start-2 row-start-1 col-span-2 justify-end" h=16 w=16>
        <img src="images/menu.svg" alt="" class="col-start-1 row-start-1">
        <header class="w-full col-span-4">
            <div class="lg:grid lg:grid-cols-12 container max-w-xl lg:max-w-5xl mx-auto lg:pt-24">
                <div class=" lg:col-span-12 pt-52">
                    <h1 class="font-kayak font-light text-4xl lg:text-7xl text-primary text-center lg:text-left">The <span class="font-bold tracking-wider">future<br></span> is present.</h1>
                </div>
        ...
        <div class="blur max-w-full contents">
            <div class="contents lg:flex justify-between container max-w-5xl mx-auto py-8">
                <div class="bg-none col-span-2 col-start-2">
        ...
        <div class="grid grid-cols-2">
            ...
            <?php
                ...
                foreach ($data as $line){
                    ...
                    echo "<span class='text-primary text-archivo text-5xl'>".$symbol."</span>";
                };
