...
<nav class="flex items-center justify-between flex-wrap bg-indigo-500 p-6">
            <div class="flex items-center flex-shrink-0 text-white mr-6">
                ...
                <span class="font-semibold text-xl tracking-tight ml-4 font-archivo">Driverless</span>
            </div>
    ...
    <div class="grid-cols-12">
        ...
        <div class="mx-auto mt-8 max-w-xs w-full">
            <form class="bg-white shadow-md rounded px-8 pt-6 pb-8 mb-4 grid grid-cols-2" action="<?php echo htmlspecialchars($_SERVER['PHP_SELF']); ?>" method="POST" enctype="multipart/form-data">
                <span class="font-semibold text-xl col-span-2 justify-center text-center text-gray-900 mb-8">Login</span>
                <div class="col-span-2">
                    <label for="uname" class="block text-gray-700 text-base font-semibold mb-2 justify-self-center">Username</label>
                    <input type="text" name="uname" id="uname" class="border rounded-sm mb-4 px-2 py-1 w-full leading-tight appearance-none focus:outline-none focus:shadow-outline">
                </div>
                <div class="col-span-2">
                    <label for="pw" class="block text-gray-700 text-base font-semibold mb-2 justify-self-center">Password</label>
                    <input type="password" name="pw" id="pw" class="border rounded-sm mb-4 px-2 py-1 w-full leading-tight appearance-none focus:outline-none focus:shadow-outline">
                </div>
                ...
                <span class="block sm:inline"><?php echo "The account linked to username <span class='font-bold'>".$username."</span> is locked due to too many unsuccessful login attempts. <br>Try again in <span id='countdown'></span>"?></span>
                </div>
                ...
                <input type="submit" name="submit" value="Login" class="text-gray-700 text-base font-semibold rounded-md bg-green-200 py-2 mt-8 w-full col-span-2">
