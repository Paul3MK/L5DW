...
<body class="bodygradient">
    <div class="overflow-hidden z-1">
        <img src="images/waymo.jpg" alt="" class="h-screen w-full object-cover">
    </div>
    <!--navbar-->
    ...
    <div class="container max-w-5xl mx-auto pt-16">
        ...
        <span class="pt-16 font-archivo text-primary text-xl">Please check out frequently asked questions, for any common queries.
            There's not much point typing out a question if the answer's already
            available!</span>
        <div class="col-span-4 blur p-4 rounded-md my-6">
            <div class="accordionTab flex justify-between">
                <span class="px-2 text-xl m-0 rounded-xl text-primary font-archivo focus:outline-none blur w-full text-left">
                    What's the difference between subscribe and register?
                </span>
                <img src="images/back.svg" alt="" width="16" class="accordionArrow transform rotate-180">
            </div>
            <div class="hidden accordionContent mt-4">
                <p class="font-light font-archivo text-primary text-lg text-left px-2 mt-4">You can subscribe if you wish to get on our email list and receive our newsletter containing information on Driverless and the world of autonomous vehicles.<br>Signing up makes you a member, which comes with perks such as deals, access to our magazine and other benefits.</p>
            </div>
        </div>
        <div class="col-span-4 blur p-4 rounded-md my-6">
            <div class="accordionTab flex justify-between">
                <span class="px-2 text-xl m-0 rounded-xl text-primary font-archivo focus:outline-none blur w-full text-left">
                    Which partnerships does Driverless currently have?
                </span>
                <img src="images/back.svg" alt="" width="16" class="accordionArrow transform rotate-180">
            </div>
            <div class="hidden accordionContent mt-4">
                <p class="font-light font-archivo text-primary text-lg text-left px-2 mt-4">Currently, Driverless is in talks with Nio and General Motors to become an official partner, for exclusive content and deals for our members. Also, we have partnerships with other news outlets.</p>
            </div>
        </div>
        <div class="col-span-4 blur p-4 rounded-md my-6">
            <div class="accordionTab flex justify-between">
                <span class="px-2 text-xl m-0 rounded-xl text-primary font-archivo focus:outline-none blur w-full text-left">
                    Where can I send letters or parcels?
                </span>
                <img src="images/back.svg" alt="" width="16" class="accordionArrow transform rotate-180">
            </div>
            <div class="hidden accordionContent mt-4">
                <p class="font-light font-archivo text-primary text-lg text-left px-2 mt-4">You can send physical mail to our address in Accra; check the <a href="contact.php" class="underline hover:opacity-80">contact page</a> for further details.</p>
            </div>
        </div>
        <div class="col-span-4 blur p-4 rounded-md my-6">
            <div class="accordionTab flex justify-between">
                <span class="px-2 text-xl m-0 rounded-xl text-primary font-archivo focus:outline-none blur w-full text-left">
                    Where can I find more about Driverless?
                </span>
                <img src="images/back.svg" alt="" width="16" class="accordionArrow transform rotate-180">
            </div>
            <div class="hidden accordionContent mt-4">
                <p class="font-light font-archivo text-primary text-lg text-left px-2 mt-4">This website is our media outlet. For more information about us and what we do, send us an email at: <a href="mailto:queries@driverless.com" class="underline hover:opacity-80">queries@driverless.com</a></p>
            </div>
        </div>
        <form action="<?php echo htmlspecialchars($_SERVER['PHP_SELF']); ?>" method="POST" enctype="multipart/form-data" <?php echo isset($_POST['message']) ? 'class="block"' : 'class="hidden"' ?>>
            ...
            <div>
                <span>Your message: <?php echo isset($_POST['message']) ? $_POST['message'] : ''?></span>
            </div>
