...
<body class="bodygradient">
    ...
    <div class="container max-w-5xl mx-auto pt-16">
        <div>
            <h1 class="font-kayak text-6xl text-primary">Write to us</h1>
            <span class="pt-16 font-archivo text-secondary text-xl">Feel free to fill in the form if you wish to ask an unanswered question,
                or if you wish to send a message of any other kind.</span>
            <!-- contact form goes here -->
            <form action="faq.php" method="POST" class="container max-w-xl m-auto">
                <label for="" class="font-kayak text-primary text-lg block ml-4">NAME</label>
                <div class="blur rounded-2xl">
                    <input type="text" name="name" class="p-4 block focus:outline-none w-full" style="background-color: rgba(0,0,0,0);">
                </div>
                <label for="" class="font-kayak text-primary text-lg block ml-4">EMAIL</label>
                <div class="blur rounded-2xl">
                    <input type="email" name="email" class="p-4 block focus:outline-none w-full" style="background-color: rgba(0,0,0,0);">
                </div>
                <label for="" class="font-kayak text-primary text-lg block ml-4">MESSAGE</label>
                <div class="blur rounded-2xl">
                    <textarea name="message" id="" cols="30" rows="10" class="p-4 block focus:outline-none w-full placeholder-primary" placeholder="Type your message here." style="background-color: rgba(0,0,0,0)"></textarea>
                </div>
                <div class="blur rounded-2xl mt-8">
        ...
        <div class="grid grid-cols-2">
            <div id="mapid" class="col-span-1 h-96"></div>
            <script>
            ...
            <div>
                <p>+233 553219932</p>
                <a href="mailto:#">queries@driverless.com</a>
                <p>+233 553219932</p>
            </div>
        </div>
    </div>
