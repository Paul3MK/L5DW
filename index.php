...
<body class="bodygradient">
    ...
    <div class="h-screen w-full z-2 absolute top-0" style="clip-path: polygon(0 0, 83% 0, 24% 100%, 0% 100%); backdrop-filter: blur(1px) brightness(0.85);"></div>
    <!-- navbar -->
    <header class="z-3 absolute w-full top-0">
        <nav class="w-full flex items-center justify-between flex-wrap p-6 top-0">
            <div class="flex items-center flex-shrink-0 text-white mr-6">
                ...
                <img src="images/logo.svg" alt="" h=16 w=16>
            </div>
