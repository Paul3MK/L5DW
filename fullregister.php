...
<body class="bg-gray-200">
    ...
    <form action="<?php echo htmlspecialchars($_SERVER['PHP_SELF']); ?>" method="POST" enctype="multipart/form-data" class="max-w-xl mx-auto overflow-hidden">
        <div id="firstForm" class="z-2 mx-auto mt-8 max-w-md w-full my-auto bg-white shadow-md rounded px-8 pt-6 pb-8 mb-4 grid grid-cols-1 sm:grid-cols-2 gap-x-4 gap-y-2 top-0">
            <div class="col-span-1">
                <label for="fname" class="block text-gray-700 text-xs font-semibold mb-2 justify-self-center uppercase">First name</label>
                <input required type="text" name="fname" id="fname" class="bg-gray-200 rounded-sm mb-4 px-2 py-1 w-full appearance-none focus:outline-none focus:ring">
            </div>
            <div class="col-span-1">
                <label for="lname" class="block text-gray-700 text-xs font-semibold mb-2 justify-self-center uppercase">Last name</label>
                <input required type="text" name="lname" id="lname" class="bg-gray-200 rounded-sm mb-4 px-2 py-1 w-full appearance-none focus:outline-none focus:ring">
            </div>
            <div class="sm:col-span-2">
                <label for="email" class="block text-gray-700 text-xs font-semibold mb-2 justify-self-center uppercase">Email</label>
                <input required type="email" name="email" id="email" class="bg-gray-200 rounded-sm mb-4 px-2 py-1 w-full appearance-none focus:outline-none focus:ring">
            </div>
            <div class="col-span-1">
                <label for="gender" class="block text-gray-700 text-xs font-semibold mb-2 justify-self-center uppercase">Gender</label>
               <select name="gender" id="gender" class="form-select border-transparent bg-gray-200 rounded-sm mb-4 px-2 py-1 w-full focus:outline-none focus:ring">
                   <option value="male">Male</option>
                   <option value="female">Female</option>
               </select>
            </div>
            <div class="col-span-1">
                <label for="dob" class="block text-gray-700 text-xs font-semibold mb-2 justify-self-center uppercase">Date of birth</label>
                <input required type="date" name="dob" id="dob" class="bg-gray-200 rounded-sm mb-4 px-2 py-1 w-full appearance-none focus:outline-none focus:ring">
            </div>
            <div class="col-span-1">
                <label for="paddr" class="block text-gray-700 text-xs font-semibold mb-2 justify-self-center uppercase">(Postal) Address</label>
                <input required type="text" name="paddr" id="paddr" class="bg-gray-200 rounded-sm mb-4 px-2 py-1 w-full appearance-none focus:outline-none focus:ring">
            </div>
            <div class="col-span-1">
                <label for="pcode" class="block text-gray-700 text-xs font-semibold mb-2 justify-self-center uppercase">Postal Code</label>
                <input required type="text" name="pcode" id="pcode" class="bg-gray-200 rounded-sm mb-4 px-2 py-1 w-full appearance-none focus:outline-none focus:ring">
            </div>
            <input type="reset" value="Reset" class="focus:outline-none focus:ring focus:border-blue-300 hover:bg-gray-200 col-span-1 rounded-md py-2 text-red-600 font-semibold uppercase text-sm">
            <button onclick="toggleForm('first')" type="button" class="focus:outline-none col-span-1 rounded-md py-2 bg-green-300 text-gray-900 uppercase font-semibold text-sm">Next</button>
      ...
      <!-- <form action="addaccount.php" method="POST" class="form__reg"> -->
            ...
            <button onclick="toggleForm('second')" type="button" class="focus:outline-none focus:ring focus:border-blue-300 hover:bg-gray-200 col-span-1 rounded-md py-2 text-red-600 font-semibold uppercase text-sm">Back</button>
